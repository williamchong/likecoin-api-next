...
export const userAuthCollection = FIRESTORE_USER_AUTH_ROOT ? db.collection(FIRESTORE_USER_ROOT) : null;
export const txCollection = FIRESTORE_TX_ROOT ? db.collection(FIRESTORE_TX_ROOT) : null;
export const iapCollection = FIRESTORE_IAP_ROOT ? db.collection(FIRESTORE_IAP_ROOT) : null;
export const missionCollection = FIRESTORE_MISSION_ROOT ? db.collection(FIRESTORE_MISSION_ROOT) : null;
